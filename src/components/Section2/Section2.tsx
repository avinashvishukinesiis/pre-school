  ...
  return (
	<div className='flex justify-center items-center gap-[20px]'>
		...
		<div className='flex-1' >
			...
			<p className='text-[15px]'>Look into the eyes of a young child and see the sparkle and wonder. Develop these passions and watch the adult bloom into someone special. At Cuddles, we work every day to build the foundations for amazing futures.</p>
